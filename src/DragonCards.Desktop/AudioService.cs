...
internal sealed class AudioService
{
    ...
    private string SoundForEvent(MatchEvent matchEvent) => matchEvent.Kind switch
    {
        ...
        MatchEventKind.EnergyGained or MatchEventKind.EnergySourceCreated or MatchEventKind.EnergyConverted or MatchEventKind.EnergyRefunded => SoundKeys.EnergyGain,
        MatchEventKind.EnergyRefreshed => SoundKeys.CardReady,
